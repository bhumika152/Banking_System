...
public class BankingSystem {
    ...
    private void insertIntoTable (BankAccount account) {
        if (account instanceof SavingAccount) {
            ...
            Utils.writeSavings();
 System.out.println("File Created of Accountant in SavingsFolder Successfully");
        } 
else if (account instanceof CurrentAccount) {
            current_account((CurrentAccount) account);
            Utils.writeCurrent();
 System.out.println("File Created of Accountant in CurrentFolder Successfully");
        } 
else if (account instanceof Loan) {
            loan_account((Loan) account);
            Utils.writeLoan();
 System.out.println("File Created of Accountant in LoanFolder Successfully");
        }
 }
